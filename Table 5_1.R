...
names(reg1_data)[names(reg1_data) == "lroo_placebo_treatedBOTH_10"] <- "lroo_placebo_treatedBOTH"
names(reg1_data)[names(reg1_data) == "lroo_placebo_beta_treatedBOTH_10"] <- "lroo_placebo_beta_treatedBOTH"
names(reg1_data)[names(reg1_data) == "lroo3_treatedBOTH_10"] <- "lroo3_treatedBOTH"


reg1<-plm(delta_imports_triple_alt ~ lroo_placebo_treatedBOTH + lroo_placebo_beta_treatedBOTH +
           lroo3_treatedBOTH +delta_prefmargin_j + 0,index = c("partner"),cluster= "HS2digit",reg1_data, model = "within")
...
names(reg2_data)[names(reg2_data) == "lroo_placebo_treatedBOTH_11"] <- "lroo_placebo_treatedBOTH"
names(reg2_data)[names(reg2_data) == "lroo_placebo_beta_treatedBOTH_11"] <- "lroo_placebo_beta_treatedBOTH"
names(reg2_data)[names(reg2_data) == "lroo3_treatedBOTH_11"] <- "lroo3_treatedBOTH"





reg2 <- plm(delta_imports_triple_alt ~ 
                    lroo_placebo_treatedBOTH + lroo_placebo_beta_treatedBOTH +
                    lroo3_treatedBOTH +delta_prefmargin_j +0, index = c("partner"),cluster= "HS2digit",reg2_data, model = "within")


library(stargazer)

stargazer(reg1,reg2, type = "text", dep.var.labels = c(),title="Table 5", digits=3, out="Table5_final.txt")
stargazer(reg1_1,reg2, type = "html", dep.var.labels = c(),title="Table 5", covariate.labels = c("RoO Placebo(RoO1-RoO2)","RoO Flexible(RoO2-RoO3)","RoO Strict(RoO3)","delta preferential Tariff"), digits=3, out="Table5_try.html")
